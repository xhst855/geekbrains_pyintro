"""
1. (done) Создать список и заполнить его элементами различных типов данных.
...
"""
2. (done) Для списка реализовать обмен значений соседних элементов, т.е. 
...
"""
3. (done) Пользователь вводит месяц в виде целого числа от 1 до 12. 
...
"""
4. (done) Пользователь вводит строку из нескольких слов, разделённых пробелами. 
...
"""
5. (done) Реализовать структуру «Рейтинг», представляющую собой не возрастающий набор натуральных чисел. 
...
while True:
    ...
    if input("Enter 'Done' to complete: ") == 'Done':
        break
